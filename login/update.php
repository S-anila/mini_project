...
elseif($name=="")
{
 ...
 elseif($i==30 )
    ...
    elseif($type_only=="date" )
  {
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='date' name='$name' value='$datas' class='form-control' > </div>
                                        </div>";
...
<form action='form.php' method='post'><input type='submit' name='view' value='Back' class='form-control btn-danger'></form></div></div>
